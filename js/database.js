...
<a   href="../user/cart.html" class=" btn btn-outline-light" >Order (<span id="cart-quantity">0</span>)</a>

<a class="btn btn-outline-dark ms-3" href="../user/profile.html" > ${username} </a>
